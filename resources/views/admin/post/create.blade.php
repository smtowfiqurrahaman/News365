						...
						<div class="row">
							<div class="col-md-6 col-lg-4">
								<div class="form-group">
									<label>Title</label>
									<input type="text" name="name" class="form-control" placeholder="Enter Text" required="required">
								</div>
							</div>
							...
							<div class="col-md-6 col-lg-12">
								<div class="form-group">
									...
									<textarea class="form-control" name="artical" rows="3" placeholder="Enter Your Post"></textarea>
								</div>
								<div class="card-action">
									<button class="btn btn-primary btn-round" type="submit">Post</button>
